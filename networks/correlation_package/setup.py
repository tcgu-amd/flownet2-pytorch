...
if not USE_ROCM:
    ...
    #Rename the main cc file to hip file so hipcc is used.
    shutil.move(os.path.join(source_dir, "correlation_hip.cc"),
                os.path.join(source_dir, "correlation_hip.cc.hip"))
